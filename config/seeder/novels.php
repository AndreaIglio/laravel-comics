...
return [
    ...
    [
        ...
        "cover" => "storage/img/header_home/BM_106_300-001_HD_60343a048f2af5-78911718.jpg",
        "jumbotron" => 'storage/img/jumbotron_show/2.jpeg'

    ],
    [
        "name" => "Crime Syndicate",
        "body" => "Spinning out of Dark Nights: Death Metal, the Multiverse is reborn-and Earth-3 with it! In this six-issue miniseries, witness the true origins of the malevolent makers of mayhem known as the Crime Syndicate as a common foe unites them! But how long can alliances last between villains like these? Also in this issue, it’s the origin of Ultraman in our special backup story drawn by superstar artist Bryan Hitch!",
        "cover" => "storage/img/header_home/CRIMESYN_01_300-001_HD_60343d66789362-85081498.jpg",
        "jumbotron" => 'storage/img/jumbotron_show/3.jpeg'


    ],
    [
        "name" => "Infinite Frontier",
        "body" => "The next phase of the DC Universe begins here! Dark Knights: Death Metal presented the darkest threats of the Multiverse. DC Future State revealed what may lie ahead. Now it’s time to look into the Infinite Frontier of the current-day DC Universe.
        ...
        "cover" => "storage/img/header_home/INFFRONTIER_00_300-001_HD_60343ebbcf91c6-60131949.jpg",
        "jumbotron" => 'storage/img/jumbotron_show/4.jpeg'


    ],
    [
        "name" => "Man-Bat",
        "body" => "Man-Bat is on the run from the law following a horrific night of blood and mayhem on the streets of Gotham. But the police aren’t what Kirk Langstrom’s monstrous alter ego should worry about...it’s Task Force X, better known as the Suicide Squad. To undo the damage he caused, Man-Bat must seek out a cure for the innocents he has injured, all while staying out of the deadly sights of the world’s most dangerous mercenaries!",
        "cover" => "storage/img/header_home/MANBAT_02_300-001_HD_60343d7c5bd4e9-59772997.jpg",
        "jumbotron" => 'storage/img/jumbotron_show/5.jpeg'


    ],
    [
        "name" => "Sensational Wonder Woman",
        "body" => "Ultimate Fangirl Part 1 – Katie, a spirited 98 year old woman has escaped her nursing home. As her caregivers track her down, Katie recounts her World War II adventures with Wonder Woman.",
        "cover" => "storage/img/header_home/SWW-09_CoversCredits-3_60355ea0df3695-12671771.jpg",
        "jumbotron" => 'storage/img/jumbotron_show/1.jpeg'
